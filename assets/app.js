...
var topics = ["Doctor Who", "The IT Crowd", "Monty Python's Flying Circus","The Office UK", "Portlandia", "Psych", "Sherlock"];
...
function displayRelatedGifs() {
	...
	var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + tvShow + "&api_key=yDloNpzPqal4E7dIIm5qkWRfnzIlF9UB&limit=20";
  ...
  //after getting request runs function
  .done(function(response) {
	//stores response data into variable results
